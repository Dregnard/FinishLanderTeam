...
<html>
    ...
    <body id="contenedor">
        ...
        <div id="izquierda">
            <div id="cpanel">
                <div id="botonScoresSmartphone"><p>-</p></div>
                <div id="botonJugSmartphone"><p>-</p></div>
        ...
        <div id="menuScores">
            <a href="#" onclick="ocultarScores();"><img id="close" src="img/close.png" alt="close"></a>
            <h3>Tabla de Records</h3>
            <p>Lugar donde iran las máximas puntuaciones de todos los jugadores</p>
        </div>

        <div id="menuJug">
            <a href="#" onclick="ocultarJug();"><img id="close" src="img/close.png" alt="close"></a>
            <h3>Tabla de Jugadores</h3>
            <p>Lugar donde iran los jugadores activos</p>
        </div>
